...
QT_MOC_LITERAL(1, 8, 25), // "sig_doubleClickedTitleBar"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "CWidget\0sig_doubleClickedTitleBar\0"
};
...
void CWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_doubleClickedTitleBar(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (CWidget::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CWidget::sig_doubleClickedTitleBar)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject CWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CWidget.data,
...
// SIGNAL 0
void CWidget::sig_doubleClickedTitleBar()
{
